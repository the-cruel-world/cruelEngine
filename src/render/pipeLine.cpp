...
{
    PipeLine::PipeLine(const VulkanDevice &_device, const SwapChain &_swapChain, const RenderPass &_renderPass)
    ...
    void PipeLine::createPipiLineALayout() {
        Shader vertShader (device.logicalDevice, "./vert.spv");
        Shader fragShader (device.logicalDevice, "./frag.spv");
        ...
        viewport.x = 0.0f;
        viewport.y = 0.0f;
        viewport.width = (float) swapChain.extent2dMode.width;
        viewport.height = (float) swapChain.extent2dMode.height;
        viewport.minDepth = 0.0f;
        viewport.maxDepth = 1.0f;

        VkRect2D scissor = {};
        scissor.offset = {0, 0};
        scissor.extent = swapChain.extent2dMode;
        ...
        if (vkCreateGraphicsPipelines(device.logicalDevice, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &pipeLine) != VK_SUCCESS) {
