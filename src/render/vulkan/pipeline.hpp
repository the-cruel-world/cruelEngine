...
namespace VulkanContext {
    ...
    public:
        ...
        const std::vector<ShaderModule> &get_shader_modules() const {return shaders;}
    ...
    public:
        ...
        void    set_vertex_input_state(const VertexInputState &new_vertex_input_sate) {vertex_input_sate = new_vertex_input_sate;}
        
        void    set_input_assembly_state(const InputAssemblyState &new_input_assembly_state) {input_assembly_state = new_input_assembly_state;}

        void    set_rasterization_state(const RasterizationState &new_rasterization_state) {rasterization_state = new_rasterization_state;}

        void    set_viewport_state(const ViewportState &new_viewport_state) {viewport_state = new_viewport_state;}

        void    set_multisample_state(const MultisampleState &new_multisample_state) {multisample_state = new_multisample_state;}

        void    set_depth_stencil_state(const DepthStencilState &new_depth_stencil_state) {depth_stencil_state = new_depth_stencil_state;}
        ...
        const VertexInputState    &get_vertex_input_state() const {return vertex_input_sate;}
        const InputAssemblyState  &get_input_assembly_state() const {return input_assembly_state;}
        const RasterizationState  &get_rasterization_state() const {return rasterization_state;}
