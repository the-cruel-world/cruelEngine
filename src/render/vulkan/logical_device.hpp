...
namespace VulkanContext {
    ...
    public:
        /*! \brief LogicalDevice is the data prototype of a logical Device.
            LogicalDevice creates objects that contain a logical device, and all it's informations, operations, etc.
            \param  _physicalDevice is the gpu that the logical device will be linked with.
            \param _surface is a input parameter, to check whether the device support this type surface.
            \param _layerNames, are the validation layers the enabled in the instance.
            \param _requiredExtensions are the device extensions that the device should enable.
            \param _flags are types of queue that this device should support.
        */
    ...
    public:
        ...
        Queue                       &get_suitable_present_queue(u32 queue_index);
