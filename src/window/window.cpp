...
Window::Window() : properties(WindowProp()) { createWindow(); }
...
void Window::createWindow() {
  ...
  if (properties.fullscreen)
    handle = glfwCreateWindow(properties.width, properties.height,
                              properties.title.c_str(), glfwGetPrimaryMonitor(),
                              nullptr);
  else
    handle = glfwCreateWindow(properties.width, properties.height,
