 ...
 * Skybox
 *
 * \todo Start to use the new mesh implement. */
...
public:
    SkyBox(std::string name, Camera &camera) : Object(name, camera)
    {
        ...
        //        float a = 0.5;
        //
        //        mesh->addVertex((Vertex){glm::normalize(glm::vec3(a, a, a)), glm::vec3(a, a,
        //        -a)}); mesh->addVertex((Vertex){glm::normalize(glm::vec3(a, -a, a)), glm::vec3(a,
        //        -a, -a)}); mesh->addVertex((Vertex){glm::normalize(glm::vec3(-a, -a, a)),
        //        glm::vec3(-a, -a, -a)}); mesh->addVertex((Vertex){glm::normalize(glm::vec3(-a, a,
        //        a)), glm::vec3(-a, a, -a)});
        //
        //        mesh->addVertex((Vertex){glm::normalize(glm::vec3(a, a, -a)), glm::vec3(a, a,
        //        a)}); mesh->addVertex((Vertex){glm::normalize(glm::vec3(a, -a, -a)), glm::vec3(a,
