...
void SphereTask::render() {
  ...
  ubo.view =
      glm::lookAt(glm::normalize(glm::vec3(1.0f, -1.0f, -2.0f))*glm::vec3(3.0), glm::vec3(0.0f, 0.0f, 0.0f),
                  glm::vec3(0.0f, -1.0f, 0.0f));
  ubo.proj =
...
void Icosahedron(Mesht &mesh) {
  ...
  mesh.vertices.emplace_back((Vertex){glm::normalize(glm::vec3(a, a, a)), glm::vec3(a, a, -a)});
  mesh.vertices.emplace_back((Vertex){glm::normalize(glm::vec3(a, -a, a)), glm::vec3(a, -a, -a)});
  mesh.vertices.emplace_back((Vertex){glm::normalize(glm::vec3(-a, -a, a)), glm::vec3(-a, -a, -a)});
  mesh.vertices.emplace_back((Vertex){glm::normalize(glm::vec3(-a, a, a)), glm::vec3(-a, a, -a)});
